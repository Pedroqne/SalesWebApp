...
namespace SallesWebApp.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public DepartamentsController(SallesWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departament != null ? 
                          ...
                          Problem("Entity set 'SallesWebAppContext.Departament'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SallesWebAppContext.Departament'  is null.");
            }
            var departament = await _context.Departament.FindAsync(id);
            if (departament != null)
            {
